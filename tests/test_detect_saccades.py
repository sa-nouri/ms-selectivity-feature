...
def test_validate_saccades():
    ...
    saccades = [
        {'start_time': 100, 'end_time': 150, 'duration': 50, 'amplitude': 5.0, 'direction': 0},
        {'start_time': 300, 'end_time': 350, 'duration': 50, 'amplitude': 4.0, 'direction': 45},
        {'start_time': 500, 'end_time': 550, 'duration': 50, 'amplitude': 6.0, 'direction': 90},
        {'start_time': 700, 'end_time': 750, 'duration': 50, 'amplitude': 3.0, 'direction': 135}
    ]
